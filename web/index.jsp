    ...
    <body>
        ...
        <table class="login" border="0">
            <tr>
                ...
                <form action="login" name="loginform" method="POST" onsubmit="return checkLValid()">
                    <br><h2 style="color:cyan">Login</h2>
                    Username<br>
                    <input type="text" name="user" placeholder="username or email"><br><br><br>
                    Password<br>
